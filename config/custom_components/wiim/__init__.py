...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    # Fetch friendly name from device
    device_status = await client.get_status()
    friendly_name = device_status.get("device_name") or entry.data["host"]
    ...
    coordinator.friendly_name = friendly_name  # Store for use by entities
